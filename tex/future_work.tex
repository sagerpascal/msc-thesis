...
In \secref{neuroscience_findings}, important neuroscientific findings are identified, responsible for the effectiveness of the biological vision system that does not have these drawbacks of deep networks.
...
In \secref{limitationsDL}, some of the most pressing limitations of deep networks are pointed out.
...
However, numerous avenues exist for future work to improve the proposed framework.
...
In \secref{framework_alt_cells}, it is describds that alternative cells could be implemented by duplicating the output channels of the weight matrix $\boldsymbol{W}$ of \emph{S1}.
