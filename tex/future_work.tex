...
\The prototype stage \emph{S2} is inspired by the ventral visual stream and the temporal cortex.
...
In a first step, projection fibres based on shifter circuits \sidecite{anderson_shifter_1987, olshausen_neurobiological_1993} should be implemented and tested with the proposed framework.
