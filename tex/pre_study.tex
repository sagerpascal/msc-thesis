%% pre_study.tex
In this preliminary study, I examine what representations of typical deep learning architectures look like.
...
Figure \figref*{pre_study_components} visualizes these basic components (basic lines on the left, digits on the right).
...
An exemplary composition of network fragments of the number $9$ across $4$ subsequent layers is shown in Figure \figref*{pre_study_composition}.
