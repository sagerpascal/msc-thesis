...
\end{figure}
A straight-forward approach is to apply different operations such as translation, rotation, and deformation to a reference frame as shown in \figref{prototype_operations}. These operations can be applied either separately or in combination.
...
The hierarchical mapping was introduced by \sideciteay{anderson_shifter_1987} under the name ``shifter circuits'' and later improved by \sideciteay{olshausen_neurobiological_1993}.
...
Alle Zellen an jede Position verbinden: 32*32 connections
...
As described in \secref{framework_s1}, this prototype from \emph{L2} can overwrite the representations in \emph{L1} and is thus incorporated in the learning process in \emph{L1}.
