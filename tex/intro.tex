...
Furthermore, deep networks suffer from various issues of statistical learning, such as missing robustness \sidecite{akhtar_threat_2018, long_survey_2022}, catastrophic forgetting \sidecite{kirkpatrick_overcoming_2017}, or requiring vast amounts of data \sidecite{smith_using_2022}.
...
\chref{rel_work} introduces the related work. Next, \chref{biological_inspiration} identifies promising biological concepts for visual object recognition.
Afterwards, \chref{probabilistic_framework} proposes a novel implementation of the identified biological concepts within a computational framework.
...
Thus, Chapters \chref*{fundamentals}-\chref*{biological_inspiration} survey existing work and put it into context, while Chapters \chref*{probabilistic_framework}-\chref*{future_work} introduce and discuss a novel vision framework.
