...
The remainder of the thesis is organised as follows: In \chref{fundamentals}, deep learning and neurocomputing fundamentals are explained in detail; experts may skip this chapter.
