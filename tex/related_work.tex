...
Von der Malsburg et al. \sidecite{von_der_Malsburg_Stadelmann_Grewe_2022} have not addressed how their interesting theoretical concepts can be implemented in a mathematical model.
...
According to \sideciteay{Duan_Principe_2022} and \sideciteay{Bartunov_Santoro_Richards_Marris_Hinton_Lillicrap_2018}, only proxy objective functions have achieved competitive performance with large models on large datasets such as ImageNet \sidecite{Deng_Dong_Socher_Li_KaiLi_LiFei_Fei_2009}.
...
Other approaches meta-learn the optimiser of the inner base learning algorithm \cite{ravi2016optimization, Li_Malik_2016, Li_Zhou_Chen_Li_2017}.
...
First, the inner base-learning episodes can either take few \sidecite{ravi2016optimization, 10-5555-3305381-3305498} or many \sidecite{10-5555-3305381-3305502, 10-5555-3305890-3306069} samples, and thus the goal can be to either improve few- or many-shot performance.
