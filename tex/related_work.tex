...
As will be outlined in \secref{framework_neuroscience}, these stages are inspired by the human brain: The eyes activate cells in the primary visual cortex \sidecite{tong_primary_2003, grill-spector_human_2004} that represent the visually perceived scene.
...
This chapter presents different implementations of projection fibres, while \secref{framework_neuroscience} discusses biological aspects in more detail. 
...
Net fragments are consistent groups of neurons representing well-known patterns and are explained in detail in \secref{framework_neuroscience}.
