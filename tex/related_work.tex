...
\paragraph{Actionable Representations.} Another frequently used principle inspired by biological learning is the combination of representations with actions \sidecite{knoblich_social_2006, zhou_does_2019}. It is that animals integrate their actions (i.e., movements) with incoming sensory signals \sidecite{keller_sensorimotor_2012}.
...
In this section, the theory of natural intelligence proposed by \sideciteay{von_der_malsburg_theory_2022}, which serves as the foundation of this thesis, is discussed.
...
Self-organisation is the only mechanism that experiments have not yet disproved as the brains Kolmogorov algorithm \sidecite{willshaw_how_1976, willshaw_marker_1979, singer_brain_1986, kelso_selforganizing_1995, kelso_dynamic_1999}.
...
In this section, different implementations of projection fibres are presented, while in \secref{neuroscience_findings_projection_fibres}, biological aspects are discussed in more detail. 

Projection fibres map images to reference objects and can be defined as matching labelled subgraphs \sidecite{bienenstock_neural_1987, lades_distortion_1993, wiskott_face_1996}.
...
Cells in NCAs can be trained with gradient descent to grow given 2D patterns such as images \sidecite{mordvintsev_growing_2020, mordvintsev_growing_2022}.
