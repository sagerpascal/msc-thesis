...
Vertical self-organisation described in \chref{vertical_self_org} is based on layer-wise learning. In this approach, the layers of a neural network are considered separate units and are updated independently.
...
Horizontal self-organisation is described in \chref{horizontal_self_org}.
...
The approach based on vertical self-organisation uses proxy objective functions to train the layer locally as independent units (c.f. \chref{vertical_self_org}).
