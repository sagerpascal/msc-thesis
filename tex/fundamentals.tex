...
Furthermore, the principle of shifting kernels is adopted to provide support between cells independent of the spatial location (c.f. \secref{framework_s1_lat_support}).
