...
As outlined in \secref{intro_motivation}, layer-wise data processing leads to early commitment. Within the context of this thesis's framework, hierarchical representations are not build over multiple layers but within the same layer as outlined in \secref{framework_3_staged_model}.
