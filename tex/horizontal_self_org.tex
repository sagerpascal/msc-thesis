...
The first section presents the methodology (i.e. how horizontal self-organisation was implemented), and the second section evaluates the obtained results.


\section{Methods}\seclbl{horizontal_self_org_methods}
The first choice for networks based on horizontal self-organisation is what the independent units are, i.e. which network parameters are trained independently.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.99\textwidth]{horizontal_gradient_flow}
